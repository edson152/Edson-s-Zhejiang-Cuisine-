    ...
    <div class="modal-dialog modal-full-height  modal-md" role="document">
      ...
      <div class="modal-body">
        ...
        <footer class="bg-light py-5">
            <div class="container"><div class="small text-center text-muted">Copyright © 2021 - Edson's Zhejiang Cuisine <a href="https://www.campcodes.com" target="_blank">CS 201938330189</a></div></div>
        </footer>
